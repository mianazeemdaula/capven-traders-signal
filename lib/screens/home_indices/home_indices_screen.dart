...
import 'package:tradiing_app/models/indices_model.dart';

class HomeIndicesScreen extends StatelessWidget {
  @override
        ...
        return Padding(
          ...
          child: GridView.builder(
            ...
            itemBuilder: (context, index) {
              var forex = Indices.fromSnapshot(snapshot.data.docs[index]);
              return ItemCard(
